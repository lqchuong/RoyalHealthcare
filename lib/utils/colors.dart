...
class AppColors{
  ...
  static final Color mainColor = const Color(0xff0d3f82);
  ...
  static final Color signColor = const Color(0xFFf7f6f4);
  ...
  static final Color redColor = const Color(0xff9e0011);
  static final Color shadowColor = const Color(0xffe3e3e3);
}