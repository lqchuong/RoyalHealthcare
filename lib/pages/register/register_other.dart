...
import '../home/main_hopital_page.dart';
                ...
                Positioned(
                    ...
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            BigText(text: "PHIẾU ĐĂNG KÝ CHO NGƯỜI THÂN", fontWeight: FontWeight.w500,),
                            SizedBox(height: 10,),
                            SmallText(text: "Đăng ký khám chữa bệnh cho người thân", color: Colors.black38,),
                            SizedBox(height: 30,),
                            Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 16,),
                                AppTextField(text: "Họ và tên người khám",color: Colors.black54, icon: Icons.person),
                                SizedBox(height: 16,),
                                AppTextField(text: "Địa chỉ người khám",color: Colors.black54,icon: Icons.location_on),
                                SizedBox(height: 16,),
                                AppTextField(text: "Số điện thoại người khám",color: Colors.black54,icon: Icons.phone),
                                SizedBox(height: 16,),
                                AppTextField(text: "CMND hoặc số căn cước người khám",color: Colors.black54,icon: Icons.card_membership),
