                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 24,),
                            SmallText(text: "Chọn loại khám", color: Colors.black,size: 16,),
                            //giới tính
                            Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                Row(
                                  children: [
                                    Radio(value: CheckType.plan, groupValue: _checktype, onChanged: (CheckType? value) {
                                      setState(() {
                                        _checktype = value;
                                      });
                                    }),
                                    SmallText(text: 'Theo lịch', color: Colors.black,size: 16,),
                                  ],
                                ),
                                Row(
                                  children: [
                                    Radio(value: CheckType.require, groupValue: _checktype, onChanged: (CheckType? value) {
                                      setState(() {
                                        _checktype = value;
                                      });
                                    }),
                                    SmallText(text: "Theo yêu cầu", color: Colors.black,size: 16,),
                                  ],
                                ),
                              ],
                            ),
